...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BundleContents) DeepCopyInto(out *BundleContents) {
	*out = *in
	if in.Objects != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BundleContents.
func (in *BundleContents) DeepCopy() *BundleContents {
	if in == nil {
		return nil
	}
	out := new(BundleContents)
	in.DeepCopyInto(out)
	return out
}
